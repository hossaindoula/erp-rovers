...
<script>
    ...
    var numberOfProfileUpdateTime = 0;
    jQuery(document).ready(function(){
        // Textarea Autogrow
        jQuery('#tapost').autogrow();
        dwr.engine.setActiveReverseAjax(true);
    });

    function allMoments(){
        profileService.findAllMomentsBySessionUser();
    }
    ...
    function sendMessage() {
        profileService.save(dwr.util.getValue("tapost"));
        //var p = document.createElement("p");
        //p.innerHTML = "ronnie" + numberOfProfileUpdateTime++;
        /*var newMoment = document.getElementById("newMoment").getElementsByTagName("div")[0];
        var oldNewMoment = newMoment.cloneNode(true);
        var oldMoment = document.getElementById("oldMoment");
        oldMoment.insertBefore(oldNewMoment);
        document.getElementById("newMoment").getElementsByTagName("div")[0].remove();*/

        //document.getElementById("oldMoment").insertBefore(p, document.getElementById("oldMoment").firstChild);



        //$(dynamicMomentHTML()).insertBefore($('.tl-post'));
...
<ul class="breadcrumbs">
    <li><a href="${rc.getContextPath()}"><i class="iconfa-home"></i></a> <span class="separator"></span></li>
    <li>Moments</li>
...
<ul class="nav nav-tabs buttons-icons">
    <li class="active"><a data-toggle="tab" href="#me">Me</a></li>
    <li><a data-toggle="tab" href="#moments">Moments</a></li>
...
<div id="me" class="tab-pane active">
    <ul class="timelinelist">
        <li>
            ...
            <div class="tl-post">
                <div class="tl-texta">
                    <textarea id="tapost" class="input-block-level" placeholder="Update your moment"  onkeypress="dwr.util.onReturn(event, sendMessage)"></textarea>
...
<div class="footer">
    <div class="footer-left">
        <span>&copy; 2013. Rovers. All Rights Reserved.</span>
    </div>
